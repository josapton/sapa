...
export default function Welcome({ auth, submissions, stats }) {
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 selection:bg-orange-500 selection:text-white transition-colors duration-200">
            <Head title="SAPA - Sistem Aduan Aspirasi dan Pelaporan Akademik" />
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex justify-between h-16">
                        <div className="flex items-center">
                            ...
                            <span className="ml-2 text-sm font-medium text-gray-500 dark:text-gray-400 hidden sm:block">
                                Sistem Aduan Aspirasi dan Pelaporan Akademik
                            </span>
                        </div>
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="text-center mb-16">
                    <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight text-gray-900 dark:text-white mb-4">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-16">
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col items-center justify-center text-center hover:shadow-md transition">
                        <div className="p-3 bg-blue-50 dark:bg-blue-900/30 text-blue-600 dark:text-blue-400 rounded-full mb-3">
                            <FileText size={24} />
                        </div>
                        <div className="text-3xl font-bold text-gray-900 dark:text-white">{stats.total_laporan}</div>
                        <div className="text-sm text-gray-500 dark:text-gray-400 font-medium mt-1">Total Laporan & Aduan</div>
                    </div>
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col items-center justify-center text-center hover:shadow-md transition">
                        <div className="p-3 bg-yellow-50 dark:bg-yellow-900/30 text-yellow-600 dark:text-yellow-400 rounded-full mb-3">
                            <Clock size={24} />
                        </div>
                        <div className="text-3xl font-bold text-gray-900 dark:text-white">{stats.laporan_diproses}</div>
                        <div className="text-sm text-gray-500 dark:text-gray-400 font-medium mt-1">Sedang Diproses</div>
                    </div>
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col items-center justify-center text-center hover:shadow-md transition">
                        <div className="p-3 bg-green-50 dark:bg-green-900/30 text-green-600 dark:text-green-400 rounded-full mb-3">
                            <CheckCircle size={24} />
                        </div>
                        <div className="text-3xl font-bold text-gray-900 dark:text-white">{stats.laporan_selesai}</div>
                        <div className="text-sm text-gray-500 dark:text-gray-400 font-medium mt-1">Selesai Ditangani</div>
                    </div>
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 flex flex-col items-center justify-center text-center hover:shadow-md transition">
                        <div className="p-3 bg-purple-50 dark:bg-purple-900/30 text-purple-600 dark:text-purple-400 rounded-full mb-3">
                            <MessageCircle size={24} />
                        </div>
                        <div className="text-3xl font-bold text-gray-900 dark:text-white">{stats.total_aspirasi}</div>
                        <div className="text-sm text-gray-500 dark:text-gray-400 font-medium mt-1">Total Aspirasi</div>
                    </div>
                </div>
                ...
                <div>
                    <div className="flex items-center justify-between mb-8">
                        <h2 className="text-2xl font-bold text-gray-900 dark:text-white">Suara Publik</h2>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {submissions.data.length === 0 ? (
                            ...
                            submissions.data.map((submission) => {
                                ...
                                return (
                                    <div key={submission.id} className="bg-white dark:bg-gray-800 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700 overflow-hidden hover:shadow-md transition flex flex-col">
                                        <div className="p-6 flex-grow">
                                            <div className="flex justify-between items-start mb-4">
                                                <div className="flex items-center space-x-2">
                                                    ...
                                                    <div>
                                                        <div className="font-semibold text-gray-900 dark:text-gray-100">{submission.user.pseudonym}</div>
                                            ...
                                            <Link href={route('submissions.show', submission.id)} className="block group">
                                                ...
                                                {submission.attachments && submission.attachments.length > 0 && submission.attachments[0].mime_type.startsWith('image/') && (
                                                    <div className="mt-4 rounded-xl overflow-hidden h-40 border border-gray-100 dark:border-gray-700">
                                                        <img 
                                        ...
                                        <div className={`px-6 py-4 bg-gray-50/50 dark:bg-gray-900/50 border-t border-gray-100 dark:border-gray-700 flex items-center ${submission.type !== 'aspirasi' ? 'justify-between' : 'justify-end'}`}>
                                            ...
                                            <button 
                                                ...
                                                className={`flex items-center space-x-1.5 px-3 py-1.5 rounded-full transition-all border ${
                                                    hasLiked ? 'bg-orange-100 dark:bg-orange-900/40 text-orange-600 dark:text-orange-400 border-transparent' : 'bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400 hover:bg-orange-50 dark:hover:bg-gray-700 hover:text-orange-500 border-gray-100 dark:border-gray-700'
                                                }`}
                                            >
